...
export function Header() {
  ...
  // endret: støtter alle forside-varianter (med/uten trailing slash) for korrekt aktiv-farge ved scroll.
  const isHome = pathname === "/" || pathname.startsWith("/redovisningsbyra-site");
